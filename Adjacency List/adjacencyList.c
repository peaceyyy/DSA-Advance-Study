...
int checkForEdge(Graph *g, int edge, int targetVertex)
{

    if (edge < 0 || edge >= g->vertices)
    {
        return 0;
    }

    node_t *trav = g->nodeArr[edge]->head;
